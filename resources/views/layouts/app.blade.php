        ...
        <div class="header-top wow fadeIn">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}"><img
                        src="{{ config('app.url') . 'storage/' . $settings['logo'] }}" alt="logo image "></a>
                <div class="right-header">
                    <div class="header-info">
                        ...
                        <div class="info-inner">
                            ...
                            <span class="iconcont">
                                <a data-scroll href="#">Daily:
                                    {{ $settings['working_horse'] ?? '7:00 AM - 8:00 PM' }}</a>
                            </span>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="logo padding">
                        <a href="{{ url('/') }}"><img
                                ...
                                alt=""></a>
                        <p>{{ $settings['description'] ?? 'hi this is Locavore pork belly scen ester pine est chill wave microdosing pop uple itarian cliche artisan.' }}
                        </p>
                    </div>
                </div>
                <div class="col-md-4">
